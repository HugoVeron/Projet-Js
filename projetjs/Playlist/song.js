...
function Media(title,duration,isPlaying)
{
    ...
    this.playm = function()
    {
        // Lire le fichier audio ou vidéo à l'aide de la fonction play
    ...
    {
        // Mettre en pause le fichier audio ou vidéo à l'aide de la fonction pause
...
{
    // Constructor de song --> héritage de media pour 3 paramètres
    ...
    {
    	// Génération du code HTML associé à la musique
        ...
        // Switch pour reconnaître l'artist
        switch (artist) {
            case "PLK":
...
function Movie(title,duration,isPlaying,producer,year,path)
{
    ...
    this.toHTML = function()
    {
    	// Génération du code HTML associé à la vidéo
        //création de mon élément p
        let mon_article = document.getElementById("my_playlist");
